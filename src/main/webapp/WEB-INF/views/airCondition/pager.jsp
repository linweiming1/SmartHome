        ...
        <div class="pagination">
            <ul>
                ...
                <pg:first>
                    ...
                    <c:if test="${requestScope.page.getNumber()  != 0 }">
                        <li class="first-child"><a href="${ctx }/airCondition/list?pageOffSet=0">首页</a></li>
                    </c:if>
                </pg:first>
                ...
                <pg:first>
                    ...
                    <c:if test="${requestScope.page.getNumber()  != 0 }">
                        <li class="first-child"><a
                                href="${ctx }/airCondition/list?pageOffSet=${requestScope.page.getNumber()-1}">上一页</a>
                        </li>
                    </c:if>
                </pg:first>
                ...
                <pg:last>
                    ...
                    <c:if test="${requestScope.page.getNumber()+1 != requestScope.page.getTotalPages()}">
                        <li class="first-child"><a
                                href="${ctx }/airCondition/list?pageOffSet=${requestScope.page.getNumber()+1}">下一页</a>
                        </li>
                    </c:if>
                </pg:last>
                <!-- 末页-->
                <pg:last>
                    ...
                    <c:if test="${requestScope.page.getNumber()+1 != requestScope.page.getTotalPages()}">
                        <li class="first-child"><a
                                href="${ctx }/airCondition/list?pageOffSet=${requestScope.page.getTotalPages()-1}">末页</a>
                        </li>
                    </c:if>
                </pg:last>
