        ...
        <div class="subfiled-content">
            ...
            <div class="search-box clearfix">
                <div class="kv-item clearfix">
                    ...
                    <div class="kv-item-content">
                        <a class="sapar-btn sapar-btn-recom query-btn add">绑定新窗帘</a>
                    </div>
                    <label>&nbsp;</label>
                    <div class="kv-item-content">
            ...
            <div class="table">
                ...
                <div class="table-box">
                    ...
                    <jsp:include page="../curtain/pager.jsp">
...
<script type="text/javascript">
    $(function () {
        ...
        $(".status").click(function () {
            ...
            $.ajax({
                type: "GET",
                url: '${ctx}/curtain/changeStatus?id=' + device_id,
                dataType: "text",
                success: function (result) {
                    ymPrompt.alert({
                        message: '设备状态切换成功', title: '成功信息', handler: function () {
                            location.href = "${ctx }/curtain/list?pageOffSet=${requestScope.page.getNumber() }";
                        }
                    })
                }
            });
    ...
    function handlerDel(tp) {
        if (tp == 'ok') {
            $.ajax({
                type: "GET",
                url: '${ctx}/curtain/unBindingDevice?id=' + delete_id,
                dataType: "text",
                success: function (result) {
                    ymPrompt.alert({
